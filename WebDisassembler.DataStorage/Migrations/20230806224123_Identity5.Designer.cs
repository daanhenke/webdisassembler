...
namespace WebDisassembler.DataStorage.Migrations
{
    ...
    [Migration("20230806224123_Identity5")]
            ...
            modelBuilder.Entity("WebDisassembler.DataStorage.Models.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a2d059bd-28be-453d-bc6c-c706343d70ff"),
                            TenantId = new Guid("00539fe7-acb6-438b-be9f-6ca0b6a0c6bc"),
            ...
            modelBuilder.Entity("WebDisassembler.DataStorage.Models.Identity.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00539fe7-acb6-438b-be9f-6ca0b6a0c6bc"),
                            Name = "Admin Tenant",
                            Subdomain = "admin",
                            UserId = new Guid("8e3118f9-adc5-4b13-9cd4-cd34549b4a48")
                        });
                });
            ...
            modelBuilder.Entity("WebDisassembler.DataStorage.Models.Identity.TenantUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("8e3118f9-adc5-4b13-9cd4-cd34549b4a48"),
                            TenantId = new Guid("00539fe7-acb6-438b-be9f-6ca0b6a0c6bc"),
                            RoleId = new Guid("a2d059bd-28be-453d-bc6c-c706343d70ff")
                        });
                });
            ...
            modelBuilder.Entity("WebDisassembler.DataStorage.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8e3118f9-adc5-4b13-9cd4-cd34549b4a48"),
