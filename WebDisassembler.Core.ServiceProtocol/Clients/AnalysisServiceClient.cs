...
{
    ValueTask<StartBinaryAnalysisResponse> StartBinaryAnalysis(Guid binaryId);
}
...
public class AnalysisServiceClient : ServiceClientBase, IAnalysisServiceClient
{
    ...
    public async ValueTask<StartBinaryAnalysisResponse> StartBinaryAnalysis(Guid binaryId) => await SendRequest<StartBinaryAnalysisRequest, StartBinaryAnalysisResponse>(new(binaryId));
}